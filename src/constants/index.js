...
export const header = {
  title: 'Seja Digital Seja RDC Bank',
  subtitle:
...
export const rewards = {
  title: 'DSF Rewards - O Programa de Pontos RDC Bank',
  list: [
    {
    ...
    },
    {
      title: 'Como funciona',
      subtitle:
        'Você acumula pontos a cada transação realizada com seu cartão de crédito. Além disso, quanto mais você usar os serviços do RDC Bank, mais pontos acumula. É simples assim!',
    },
  ],
};
  ...
  list: [
    {
      ...
      role: 'Advogada',
      comment:
        'Adorei a praticidade do aplicativo do RDC Bank. Tudo o que eu preciso está ali na tela do meu celular, sem complicação.',
    },
    {
      avatar: joao,
      name: 'João Santos',
      role: 'Empresário',
      comment:
        'O programa de pontos do RDC Bank é incrível! Com os pontos que acumulo nas minhas transações, posso fazer compras em lojas parceiras. É uma ótima maneira de economizar!',
    },
    {
      avatar: maria,
      name: 'Maria Ferreira',
      role: 'Estudante',
      comment:
        'Estava procurando por um banco digital seguro e confiável e encontrei o RDC Bank. Amei a facilidade de abrir uma conta e agora faço todas as minhas transações pelo aplicativo.',
    },
    {
      avatar: carlos,
      name: 'Carlos Gomes',
      ...
      comment:
        'Eu estava cansado de ter que ir até o banco toda semana para resolver minhas pendências. Com o RDC Bank, agora consigo fazer tudo pelo celular, de forma prática e segura.',
    },
  ],
};
...
export const footer = {
  ...
  contact: [
    'contato@rdcbank.com.br',
    '(00) 1234-5678',
    'Rua Fictícia, 1234, Bairro Fictício, Cidade Fictícia - Estado Fictício',
  ],
  copy: 'Copyright © 2024 RDC Bank. Todos os direitos reservados.',
  social: [
